            ...
            <div class="popular__sorting sorting">
                ...
                <ul class="popular__sorting-list sorting__list">
                    <li class="sorting__item sorting__item--popular">
                        <a class="sorting__link <?= is_null($sort) ? "sorting__link--active" : ""; ?>" href="index.php">
                    ...
                    <li class="sorting__item">
                        <a class="sorting__link <?= ($sort === 'likes') ? "sorting__link--active" : ""; ?>" href="index.php?sort=likes">
                            <span>Лайки</span>
                            <svg class="sorting__icon" width="10" height="12">
                                <use xlink:href="#icon-sort"></use>
                            </svg>
                    ...
                    <li class="sorting__item">
                        <a class="sorting__link <?= ($sort === 'creation_time') ? "sorting__link--active" : ""; ?>" href='index.php?sort=creation_time'>
                            <span>Дата</span>
                            <svg class="sorting__icon" width="10" height="12">
                                <use xlink:href="#icon-sort"></use>
                            </svg>
            ...
            <div class="popular__filters filters">
                ...
                <ul class="popular__filters-list filters__list">
                    <li class="popular__filters-item popular__filters-item--all filters__item filters__item--all">
                        <a class="filters__button filters__button--ellipse filters__button--all <?= is_null($type_id) ? "filters__button--active" : ""; ?>" href="index.php">
                            <span>Все</span>
                        </a>
                    </li>
                    ...
                    <?php foreach ($data['types'] as $type) :?>
                        <li class="popular__filters-item filters__item">
                            <?php if ($type['class'] === 'post-photo') : ?>
                                <a class="filters__button filters__button--photo button <?= ($type_id === 1) ? "filters__button--active" : ""; ?>" href="index.php?type_id=1">
                            ...
                            <?php elseif ($type['class'] === 'post-video') : ?>
                                <a class="filters__button filters__button--video button <?= ($type_id === 2) ? "filters__button--active" : ""; ?>" href="index.php?type_id=2">
                            ...
                            <?php elseif ($type['class'] === 'post-text') : ?>
                                <a class="filters__button filters__button--text button <?= ($type_id === 3) ? "filters__button--active" : ""; ?>" href="index.php?type_id=3">
                            ...
                            <?php elseif ($type['class'] === 'post-quote') : ?>
                                <a class="filters__button filters__button--quote button <?= ($type_id === 4) ? "filters__button--active" : ""; ?>" href="index.php?type_id=4">
                            ...
                            <?php elseif ($type['class'] === 'post-link') : ?>
                                <a class="filters__button filters__button--link button <?= ($type_id === 5) ? "filters__button--active" : ""; ?>" href="index.php?type_id=5">
