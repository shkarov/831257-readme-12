...
VALUES
       ('2019-12-20 01:10:00', 'Цитата', 'Мы в жизни любим только раз, а после ищем лишь похожих', 'С.А.Есенин', '', '', '', 1, 1, 2),
       ('2020-02-09 10:53:10', 'Игра престолов',
        ...
        '', '', '', '', 0, 2, 1),
       ('2020-03-21 19:55:03', 'Наконец, обработал фотки!', '', '', 'img/rock-medium.jpg', '', '', 2, 3, 3),
       ('2020-04-04 15:39:33', 'Моя мечта', '', '', 'img/coast-medium.jpg', '', '', 2, 1, 3),
       ('2020-04-19 05:59:59', 'Лучшие курсы', '', '', '', '', 'www.htmlacademy.ru', 3, 2, 5);
